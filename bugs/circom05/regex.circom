...
template TestRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[4] <== and[13][i].out;
		...
		multi_or[4][i].in[0] <== eq[11][i].out;
		multi_or[4][i].in[1] <== eq[12][i].out;
		multi_or[4][i].in[2] <== eq[13][i].out;
		multi_or[4][i].in[3] <== eq[14][i].out;
		multi_or[4][i].in[4] <== eq[15][i].out;
		multi_or[4][i].in[5] <== eq[16][i].out;
		multi_or[4][i].in[6] <== eq[17][i].out;
		multi_or[4][i].in[7] <== eq[18][i].out;
		multi_or[4][i].in[8] <== eq[19][i].out;
		multi_or[4][i].in[9] <== eq[20][i].out;
		multi_or[4][i].in[10] <== eq[21][i].out;
		multi_or[4][i].in[11] <== eq[22][i].out;
		multi_or[4][i].in[12] <== eq[23][i].out;
		multi_or[4][i].in[13] <== eq[24][i].out;
		...
		multi_or[6][i].in[3] <== and[20][i].out;
		multi_or[6][i].in[4] <== and[21][i].out;
...
component main {public [msg]} = TestRegex(600);